...
from app.core.schema.transaction_schema import BulkTransactionResponse, TransactionCreate, TransactionResponse
...
@router.post("/transactions/upload-csv", response_model=BulkTransactionResponse)
